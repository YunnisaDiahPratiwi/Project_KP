        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color:#2D6B36; position: fixed; top: 80px; left: 0; height: calc(100% - 80px); overflow-y: auto;">
